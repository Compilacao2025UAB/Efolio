...
public class MOCLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"NEWLINE", "DOT", "COMA", "SEMICOLON", "LEFTBRACE", "RIGHTBRACE", "LEFTBRACKET", 
			"RIGHTBRACKET", "LEFTPARENTESIS", "RIGHTPARENTESIS", "ASSIGN", "BLOCKCOMMENT", 
			"LINECOMMENT", "ADD", "SUBTRACT", "MULTIPLY", "DIVIDE", "MODULE", "NOT", 
			"AND", "OR", "LT", "GT", "LEQ", "GEQ", "EQUAL", "NOTEQUAL", "INT", "DOUBLE", 
			"VOID", "RETURN", "DOUBLE_LITERAL", "INT_LITERAL", "STRING_LITERAL", 
			"STR_ESCAPE", "IF", "ELSE", "WHILE", "FOR", "WRITE", "WRITEC", "WRITEV", 
